...
const BootSequence = ({ onComplete }) => {
  ...
  const bootMessages = [
    ...
    <span style={{ color: '#10b981', fontWeight: 'bold', fontSize: '1.2em', display: 'block', marginTop: '10px' }}>ACCESS GRANTED.</span>,
        ...
        >
          ...
          <style jsx>{`
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .boot-content { position: relative; z-index: 3; text-shadow: 0 0 5px rgba(16, 185, 129, 0.6); word-wrap: break-word; overflow-wrap: break-word; max-width: 100%; }
            ...
            @media (max-width: 800px) {
              ...
              /* FIX FOR PRELOADER OVERFLOW ON MOBILE */
              .boot-sequence { padding: 1.5rem; justify-content: flex-start; }
              .boot-content { position: relative; z-index: 3; text-shadow: 0 0 5px rgba(16, 185, 129, 0.6); word-break: break-all; white-space: pre-wrap; width: 100%; max-width: 100%; }
              .boot-log { font-size: 0.75rem; margin-bottom: 4px; }
